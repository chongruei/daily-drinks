...
var ShoppingCart = function ShoppingCart() {
  ...
  var handleIncreaseProductQuantity = function handleIncreaseProductQuantity(product) {
    return function () {
      ...
      dispatch(Object(_services_cart_actions__WEBPACK_IMPORTED_MODULE_10__["changeProductQuantity"])(newProduct, productIndex));
    };
  };
...
var changeProductQuantity = function changeProductQuantity(product, index) {
  return {
...
var cartReducer = function cartReducer() {
  ...
  switch (action.type) {
    ...
    case _actionTypes__WEBPACK_IMPORTED_MODULE_8__["CHANGE_PRODUCT_QUANTITY"]:
      return _objectSpread({}, state, {
        products: Object(_babel_runtime_corejs2_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_6__["default"])(products.splice(action.payload.index, 1, action.payload.product))
      });
...
//# sourceMappingURL=_app.js.09a7c1dabb88dce6ff62.hot-update.js.map